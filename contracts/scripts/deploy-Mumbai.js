...
async function main() {
  console.log("🚀 Deploying VideoGuard contract to Polygon Mumbai testnet...\n");
  ...
  if (balance === 0n) {
    ...
    console.log("   Or: https://mumbaifaucet.com/\n");
  }
  ...
  // Create .env template
  const envTemplate = `
# VideoGuard Smart Contract Configuration
...
`;
  ...
  console.log("Network:         ", "Polygon Mumbai Testnet (ChainID: 80001)");
